...
public:
    ...
    [[nodiscard]] SpanStatus status() const { return m_status; }
    [[nodiscard]] const std::string& statusDescription() const { return m_statusDescription; }
    [[nodiscard]] std::chrono::steady_clock::time_point startTime() const { return m_startTime; }
    [[nodiscard]] std::chrono::steady_clock::time_point endTime() const { return m_endTime; }

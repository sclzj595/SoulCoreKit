...
public:
    ...
    sc::rpc::RpcTransportType type() const override { return sc::rpc::RpcTransportType::Http; }
    void setCodec(std::shared_ptr<sc::rpc::IRpcCodec>) override {}
...
void TestRpc::testLoadBalancerRoundRobin() {
    sc::rpc::WeightedLoadBalancer lb;
    lb.setRoundRobin();

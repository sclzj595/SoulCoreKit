...
void runFullStackDemo() {
    ...
    dbConfig.filePath = "example.db";
    auto pool = ::std::make_shared<DefaultDbConnectionPool>(dbConfig);
    SQLiteRepository<User> userRepo(pool);
    ...
    sc::mq::ConnectionConfig mqConfig;
